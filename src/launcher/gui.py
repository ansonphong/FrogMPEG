...
class LauncherGui:
    ...
    def create_header(self) -> Panel:
        ...
        logo = Text()
        logo.append("\n")
        logo.append("  ______                __  ___ ____  ________ \n", style=COLORS["success"])
        logo.append(" / ____/________  ____ /  |/  // __ \\/ ____/ / \n", style=COLORS["success"])
        logo.append("/ /_  / ___/ __ \\/ __ `/ /|_/ // /_/ / __/ / /  \n", style=COLORS["bright"])
        logo.append("/ __/ / /  / /_/ / /_/ / /  / // ____/ /___/ /___\n", style=COLORS["primary"])
        logo.append("/_/   /_/   \\____/\\__, /_/  /_//_/   /_____/_____/\n", style=COLORS["muted"])
        logo.append("                /____/                            \n", style=COLORS["muted"])
        logo.append("\n")
