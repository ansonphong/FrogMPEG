...
| `python -m src convert FOLDER --preset NAME --format KEY --extension EXT --rotate 90 --speed 2` | Headless image sequence → video. `--rotate` is 0, 90, -90, 180, or 270. `--speed 2` keeps every frame and halves the duration |
